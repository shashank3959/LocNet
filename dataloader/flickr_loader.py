...
class FlickrDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        # Obtain image and caption if in training and validation mode
        if self.mode in ['train', 'val'] and self.parse_mode == 'phrase':
            ...
            if self.pad_caption:
                caption.append([self.end_word] * (self.pad_limit - len(caption_tokens)))
