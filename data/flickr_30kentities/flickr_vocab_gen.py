...
def random_glove_generator(emb_mean, emb_stddev):
    """
    Generate glove embedding randomly for unseen words
    :param emb_mean: mean for embedding matrix
    :param emb_stddev: std dev for embedding matrix
    :return: return embedding generated randomly from normal distribution of embedding matrix
    """
...
def gen_annotations(annotation_file):
    ...
    with open(annotation_file, encoding='utf-8') as f:
        for line in f:
            ...
            anns[image_id[:-2]].append(caption)
...
if __name__ == "__main__":
    ann_file = 'results_20130124.token'
    embed_file = 'glove.6B.300d.txt'
    vocab_glove_file = 'vocab_glove_flickr.json'
